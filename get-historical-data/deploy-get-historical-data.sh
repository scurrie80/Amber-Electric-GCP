...
# Declarations
readonly my_function_name='amber-grenville-get-historical-data' # change to your function name
...
readonly source_python_file='get-historical-data.py'
readonly entry_point_name='process_historical_data'
...
readonly scheduler_description="Periodically triggers the ${my_function_name} Cloud Function to fetch Amber historical data."
readonly scheduler_schedule="0 2 * * *" # Example: Run daily at 2:00 AM. Adjust as needed.
readonly scheduler_time_zone="Australia/Sydney" # Example: Set to your desired timezone.
readonly scheduler_sa_name="scheduler-invoker-sa" # Short name for the service account (can be shared if permissions are managed per function)
